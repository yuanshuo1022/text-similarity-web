    ...
    (<div
     ...
     <div className="flex ">
      ...
      <div className="flex flex-col md:grid md:grid-cols-1 gap-1">
        <Card
          ...
          <CardHeader className="mb-4">
            <h2
              className="text-2xl font-bold text-[#2d3748] border-b-2 border-[#2d3748] inline-block pb-1">分词文本</h2>
          </CardHeader>
          <CardContent>
            <textarea
      ...
      <Card
        ...
        <CardHeader className="mb-4">
          <h2
            className="text-2xl font-bold text-[#2d3748] border-b-2 border-[#2d3748] inline-block pb-1">分词结果</h2>
        </CardHeader>
        <CardContent>
